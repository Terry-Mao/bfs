...
func (pc *pooledConnection) Get(cmd string, key string) (*Reply, error) {
	return pc.c.Get(cmd, key)
}
func (pc *pooledConnection) Gets(cmd string, keys ...string) ([]*Reply, error) {
	return pc.c.Gets(cmd, keys...)
}
func (pc *pooledConnection) Touch(key string, timeout int32) error {
	return pc.c.Touch(key, timeout)
}
func (pc *pooledConnection) Delete(key string) error {
...
func (ec errorConnection) Get(cmd string, key string) (*Reply, error) {
	return nil, ec.err
}
func (ec errorConnection) Gets(cmd string, keys ...string) ([]*Reply, error) {
	return nil, ec.err
}
func (ec errorConnection) Touch(key string, timeout int32) error {
	return ec.err
}
func (ec errorConnection) Delete(key string) error {
	return ec.err
}
